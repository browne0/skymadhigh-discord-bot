...
export default (async msg => {
  ...
  const collector = await helpMessage.createReactionCollector((reaction, user) => !user.bot);

  collector.on('collect', async r => {
    const newEmbed = new RichEmbed().setColor('ORANGE').setTimestamp(new Date()).setFooter('© Sky Mad High Bot');
